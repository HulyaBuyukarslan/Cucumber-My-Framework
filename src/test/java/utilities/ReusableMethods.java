...
//        Actions actions = new Actions(driver);
    ...
    public static void clearMethodBilling(){
        ...
        vendorBillingAddressPage.lastname.clear();
        vendorBillingAddressPage.companyname.clear();
        vendorBillingAddressPage.street1.clear();
        vendorBillingAddressPage.street2.clear();
        vendorBillingAddressPage.zipcode.clear();
        vendorBillingAddressPage.towncity.clear();
        vendorBillingAddressPage.phone.clear();
